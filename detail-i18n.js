    ...
    const pages = {
        "digital-clock": {
            ...
            hr: {
                ...
                description: "Besplatan prilagodljiv Digital Clock za Windows, Android i web s alarmima, mjeračem vremena, svjetskim satom, štopericom i noćnim načinom.",
                ...
                info: `<h2>Što radi Digital Clock</h2><p>Digital Clock prikazuje vrijeme i datum velikim prilagodljivim prikazom te uključuje alarme, mjerač vremena, štopericu, svjetski sat i spremljene profile. Isti projekt dostupan je kao web aplikacija te kao posebna Windows i Android aplikacija.</p><p>Windows verzija dodaje integraciju s radnom površinom, noćni način uz krevet, ikonu u system trayu, ugrađenu provjeru nadogradnji i opcionalni Digital Clock čuvar zaslona. Android verzija prilagođena je mobitelima i tabletima te uključuje noćni način s OLED zaštitom.</p><h3>Glavne prednosti</h3><ul><li>Velik i prilagodljiv prikaz vremena i datuma.</li><li>Windows, Android i web verzija.</li><li>Alarmi, mjerač vremena, štoperica i svjetski sat.</li><li>Spremljeni profili, boje, fontovi i kontrole prikaza.</li><li>Besplatno korištenje bez Apps & Games računa.</li></ul><h3>Kada može biti koristan</h3><p>Digital Clock može služiti kao sat uz krevet, stolni sat, prikaz vremena preko cijelog zaslona, sat na drugom monitoru ili stalno vidljiv sat na mobitelu i tabletu.</p><h3>Odaberi svoju verziju</h3><p>Web verziju možeš odmah koristiti u pregledniku, Windows installer donosi nativne desktop funkcije i podršku za Screen Saver, a Android APK namijenjen je mobitelima i tabletima.</p><h3>Privatnost i dostupnost</h3><p>Za korištenje aplikacije nije potreban Apps & Games račun. Postavke i profili spremaju se lokalno na uređaju gdje je to podržano. Informacije o analitici, oglašavanju i privatnosti nalaze se u dokumentu <a href="privacy-policy"><u>Pravila privatnosti</u></a>.</p>`
            },
            de: {
                title: "Digital Clock — Windows, Android & Web | Apps & Games",
                description: "Kostenlose anpassbare Digitaluhr für Windows, Android und Web mit Weckern, Timer, Weltzeituhr, Stoppuhr und Nachttischmodus.",
                ...
                info: `<h2>Was Digital Clock macht</h2><p>Digital Clock bietet eine grosse anpassbare Zeit- und Datumsanzeige sowie Wecker, Countdown-Timer, Stoppuhr, Weltzeituhr und gespeicherte Profile. Das Projekt ist als Web-App sowie als eigene Windows- und Android-App verfügbar.</p><p>Die Windows-Version ergänzt Desktop-Integration, Nachttischmodus, Taskleisten-Symbol, integrierte Update-Prüfung und einen optionalen Digital Clock-Bildschirmschoner. Die Android-Version ist für Smartphones und Tablets optimiert und bietet einen Nachtmodus mit OLED-Schutz.</p><h3>Die wichtigsten Vorteile</h3><ul><li>Grosse und anpassbare Zeit- und Datumsanzeige.</li><li>Windows-, Android- und Web-Version.</li><li>Wecker, Timer, Stoppuhr und Weltzeituhr.</li><li>Gespeicherte Profile, Farben, Schriftarten und Anzeigeoptionen.</li><li>Kostenlos und ohne Apps-&-Games-Konto nutzbar.</li></ul><h3>Wann die App nützlich ist</h3><p>Digital Clock eignet sich als Nachttischuhr, Schreibtischuhr, Vollbild-Zeitanzeige, Uhr auf einem Zweitmonitor oder als dauerhaft sichtbare Uhr auf Smartphone und Tablet.</p><h3>Wähle deine Version</h3><p>Nutze die Web-Version sofort im Browser, installiere die Windows-Version für native Desktop-Funktionen und Bildschirmschoner-Unterstützung oder verwende die Android-APK auf Smartphone und Tablet.</p><h3>Datenschutz und Verfügbarkeit</h3><p>Ein Apps-&-Games-Konto ist nicht erforderlich. Einstellungen und Profile werden, soweit unterstützt, lokal auf dem Gerät gespeichert. Informationen zu Analyse, Werbung und Datenschutz findest du in der <a href="privacy-policy"><u>Datenschutzerklärung</u></a>.</p>`
            },
            it: {
                title: "Digital Clock — Windows, Android e Web | Apps & Games",
                description: "Digital Clock gratuito e personalizzabile per Windows, Android e web con sveglie, timer, orologio mondiale, cronometro e modalità comodino.",
                ...
                back: "Torna alle app",
                info: `<h2>Cosa fa Digital Clock</h2><p>Digital Clock offre un grande display personalizzabile per ora e data insieme a sveglie, timer, cronometro, orologio mondiale e profili salvati. Lo stesso progetto è disponibile come app web e come applicazione dedicata per Windows e Android.</p><p>La versione Windows aggiunge integrazione desktop, modalità comodino, icona nell’area di notifica, controllo aggiornamenti integrato e uno screensaver Digital Clock opzionale. La versione Android è ottimizzata per telefoni e tablet e include la modalità notte con protezione OLED.</p><h3>Vantaggi principali</h3><ul><li>Grande display personalizzabile di ora e data.</li><li>Versioni Windows, Android e web.</li><li>Sveglie, timer, cronometro e orologio mondiale.</li><li>Profili salvati, colori, font e controlli di visualizzazione.</li><li>Utilizzo gratuito senza account Apps & Games.</li></ul><h3>Quando può essere utile</h3><p>Digital Clock può essere usato come orologio da comodino, da scrivania, a schermo intero, su un secondo monitor oppure come orologio sempre visibile su telefono o tablet.</p><h3>Scegli la tua versione</h3><p>Usa subito la versione web nel browser, installa la versione Windows per le funzioni desktop native e il supporto screensaver oppure usa l’APK Android su telefono e tablet.</p><h3>Privacy e disponibilità</h3><p>Non è necessario un account Apps & Games. Impostazioni e profili vengono salvati localmente sul dispositivo dove supportato. Per analisi, pubblicità e privacy consulta l’<a href="privacy-policy"><u>Informativa sulla privacy</u></a>.</p>`
            },
            es: {
                title: "Digital Clock — Windows, Android y Web | Apps & Games",
                description: "Digital Clock gratuito y personalizable para Windows, Android y web con alarmas, temporizador, reloj mundial, cronómetro y modo de mesita.",
                ...
                info: `<h2>Qué hace Digital Clock</h2><p>Digital Clock ofrece una gran pantalla personalizable de hora y fecha junto con alarmas, temporizador, cronómetro, reloj mundial y perfiles guardados. El mismo proyecto está disponible como app web y como aplicación dedicada para Windows y Android.</p><p>La versión de Windows añade integración con el escritorio, modo de mesita, icono en la bandeja del sistema, búsqueda de actualizaciones integrada y un protector de pantalla Digital Clock opcional. La versión de Android está optimizada para móviles y tabletas e incluye modo nocturno con protección OLED.</p><h3>Ventajas principales</h3><ul><li>Gran pantalla personalizable de hora y fecha.</li><li>Versiones para Windows, Android y web.</li><li>Alarmas, temporizador, cronómetro y reloj mundial.</li><li>Perfiles guardados, colores, fuentes y controles de visualización.</li><li>Uso gratuito sin cuenta de Apps & Games.</li></ul><h3>Cuándo puede ser útil</h3><p>Digital Clock puede servir como reloj de mesita, reloj de escritorio, pantalla de hora a pantalla completa, reloj en un segundo monitor o reloj siempre visible en un móvil o tableta.</p><h3>Elige tu versión</h3><p>Usa la versión web directamente en el navegador, instala la versión de Windows para funciones nativas de escritorio y soporte de protector de pantalla, o utiliza el APK de Android en móvil y tableta.</p><h3>Privacidad y disponibilidad</h3><p>No se necesita una cuenta de Apps & Games. Los ajustes y perfiles se guardan localmente en el dispositivo cuando es compatible. Para información sobre analítica, publicidad y privacidad consulta la <a href="privacy-policy"><u>Política de privacidad</u></a>.</p>`
            }
        },
        ...
        if (slug === "digital-clock") {
            const downloads = {
                en: {
                    ...
                    windowsDescription: "Windows 10/11 x64 · Version 2.0.1 · Free installer. Includes Bedside mode, full screen, alarms, timer, world clock, stopwatch and an optional Digital Clock Screen Saver.",
                ...
                hr: {
                    ...
                    windowsDescription: "Windows 10/11 x64 · Verzija 2.0.1 · Besplatan instalacijski program. Uključuje noćni način uz krevet, cijeli zaslon, alarme, mjerač vremena, svjetski sat, štopericu i opcionalni Digital Clock čuvar zaslona.",
                ...
                de: {
                    ...
                    windowsDescription: "Windows 10/11 x64 · Version 2.0.1 · Kostenloser Installer. Mit Nachttischmodus, Vollbild, Wecker, Timer, Weltzeituhr, Stoppuhr und optionalem Digital Clock-Bildschirmschoner.",
                ...
                it: {
                    ...
                    windowsDescription: "Windows 10/11 x64 · Versione 2.0.1 · Installer gratuito. Include modalità comodino, schermo intero, sveglie, timer, orologio mondiale, cronometro e screensaver Digital Clock opzionale.",
                ...
                es: {
                    ...
                    windowsDescription: "Windows 10/11 x64 · Versión 2.0.1 · Instalador gratuito. Incluye modo de mesita, pantalla completa, alarmas, temporizador, reloj mundial, cronómetro y protector de pantalla Digital Clock opcional.",
